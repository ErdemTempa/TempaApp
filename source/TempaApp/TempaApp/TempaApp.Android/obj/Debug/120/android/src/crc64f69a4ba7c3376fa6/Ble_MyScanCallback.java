...
public class Ble_MyScanCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("TempaApp.Droid.Ble+MyScanCallback, TempaApp.Android", Ble_MyScanCallback.class, __md_methods);
	}


	public Ble_MyScanCallback ()
	{
		super ();
		if (getClass () == Ble_MyScanCallback.class)
			mono.android.TypeManager.Activate ("TempaApp.Droid.Ble+MyScanCallback, TempaApp.Android", "", this, new java.lang.Object[] {  });
	}
